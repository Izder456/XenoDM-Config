...
readonly XCLOCK_WIDTH=312
readonly XCLOCK_HEIGHT=64
readonly XCLOCK_YOFFSET=48
...
spawn_client_windows "xclock -update 1" $XCLOCK_WIDTH $XCLOCK_HEIGHT $XCLOCK_XPOS $XCLOCK_YOFFSET
